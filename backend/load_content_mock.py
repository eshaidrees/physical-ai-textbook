#!/usr/bin/env python
"""
Script to load book content into the vector store using mock embeddings for testing
"""
import sys
import os
import time
...
def load_book_content_mock():
    """
    Load book content from the documentation directory into the vector store using mock embeddings
    """
